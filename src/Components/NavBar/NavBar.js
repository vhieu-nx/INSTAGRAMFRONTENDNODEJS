                ...
                <div className="navbar__barContent">
                    <Grid container>
                        ...
                        <Grid item xs={3} style={{"display":"flex"}}>
                            <img src={home} className="navbar__img" width="25px" />
                            <img src={message} className="navbar__img" width="25px" />
                            <img src={find} className="navbar__img" width="25px" />
                            <img src={react} className="navbar__img" width="25px" />
